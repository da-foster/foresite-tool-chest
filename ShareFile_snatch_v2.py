...
now = datetime.now()
lastRun = r"\\fginc-file\GIS\Foster\ShareFile_snatch\lastRun.txt"
...
seaFolder = r"\\fginc-file\GIS\Foster\ShareFile_snatch\3GIS_Data_Exports\Seattle"
...
seaImport = r"\\fginc-file\GIS\Foster\ShareFile_snatch\3GIS_Data_Exports\Seattle_unpack"
...
seaTXT = r"\\fginc-file\GIS\Foster\ShareFile_snatch\ShareFileSnatch_TXTs\Seattle.txt"
...
print('\nThe most recent data in the Seattle ShareFile is:  ' + str(selectedDate))
print('\nThe selected folder is:  ' + str(selectedFolder))
...
with open(seaTXT, 'r+') as textFile:
    ...
    fileReadIn = textFile.read()
    txtValue = str(fileReadIn)
    print('\nThe last Seattle GDB imported was:  ' + str(txtValue))
    ...
    if txtValue != selectedName:
        ...
        print('\nSeattle data is current')

    else:
        print('\nSomething wrong happened...')


### Truncate all the tables and feature classes in the Seattle 3GIS DB if necessary, and ###

if proceed == True:

    print('\nTruncating Seattle 3GIS DB')
    ...
    ### Truncate Feature Classes ###
    truncateFeatureList = arcpy.ListFeatureClasses()
    print("\nTruncating Seattle Feature Classes:")
